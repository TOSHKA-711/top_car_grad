...
import Contact from "../home/homeComponents/contact/Contact";
import ContactLocation from "../contacy/Contact";
    ...
    <>
      <div className="car-information flex-col gap35">
        ...
        <div className="header flex-col">
          <h1>
            {detailsData.brand} {detailsData.model}
          </h1>
        ...
        <div className="info-body flex-row gap20">
          <img
            src={
              detailsData.image
                ? `http://localhost:3000${detailsData.image}`
          ...
          <div className="details flex-col gap20">
            ...
            <div className="price flex-col ">
              ...
              <button
                ...
                className="flex-row flex-center gap5 book-btn"
              >
                {" "}
                <FaBookmark /> Book Now
              </button>
